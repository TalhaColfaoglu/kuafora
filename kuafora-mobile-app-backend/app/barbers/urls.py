...
urlpatterns = [
    ...
    path("partner/barbershops/<int:pk>/catalog/<int:catalog_id>", PartnerBarbershopViewSet.as_view({'delete': 'delete_catalog_item'}), name="partner-barbershop-catalog-delete"),
    path("partner/barbershops/<int:pk>/catalog/<int:catalog_id>/", PartnerBarbershopViewSet.as_view({'delete': 'delete_catalog_item'}), name="partner-barbershop-catalog-delete-slash"),
    ...
    # Official holidays alias for APPEND_SLASH=False compatibility (hem trailing slash ile hem de olmadan)
    ...
    path("partner/holidayoverride/official-holidays", PartnerHolidayOverrideViewSet.as_view({'get': 'official_holidays'}), name="partner-holiday-override-official-holidays-alias-no-slash"),
]
