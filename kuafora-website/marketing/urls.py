...
urlpatterns = [
    ...
    path('salonlar/', views.salons, name='salons'),
    path('salonlar/<slug:slug>/', views.salon_detail, name='salon_detail'),
    path('sifre-sifirla/', views.reset_password, name='reset_password'),
